<template>
	<view class="center">
		...
		<view class="menu-container">
			...
			<view v-if="uniIDHasRole('admin') || uniIDHasRole('customerService')" class="menu-item" @click="navigateTo('/uni_modules/uni-im/pages/userList/userList', true)">
			...
			<view v-if="uniIDHasRole('admin') || uniIDHasRole('customerService')" class="menu-item" @click="navigateTo('/uni_modules/uni-im/pages/index/index', true)">
