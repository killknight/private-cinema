...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return {
        a: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            b: "366fac14-3-" + i0 + "-" + i1 + "," + ("366fac14-2-" + i0 + "-" + i1),
            c: common_vendor.p({
            ...
            f: "366fac14-2-" + i0 + "-" + i1 + "," + ("366fac14-1-" + i0)
          };
        }),
        b: "366fac14-1-" + i0 + ",366fac14-0",
        c: "366fac14-4-" + i0 + ",366fac14-0",
        d: common_vendor.p({
          state: {
            data,
            pagination,
    ...
    d: common_vendor.sr("udb", "366fac14-0"),
